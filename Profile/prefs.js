...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1620638532);
user_pref("app.update.lastUpdateTime.background-update-timer", 1620643884);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1620638652);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1620620617);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1620644020);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1620638511316");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1620640290316");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1620638512133");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1620660112133");
...
user_pref("services.blocklist.addons.checked", 1620637356);
user_pref("services.blocklist.clock_skew_seconds", 1296);
user_pref("services.blocklist.gfx.checked", 1620637356);
user_pref("services.blocklist.last_update_seconds", 1620637356);
user_pref("services.blocklist.pinning.checked", 1620637356);
user_pref("services.blocklist.plugins.checked", 1620637356);
user_pref("shell.checkDefaultApps", 0);
user_pref("shell.checkDefaultClient", false);
user_pref("signon.importedFromSqlite", true);
user_pref("storage.vacuum.last.index", 0);
user_pref("storage.vacuum.last.places.sqlite", 1620645761);
